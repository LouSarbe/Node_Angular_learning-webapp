...
var basic_flashcard_component_1 = require("./basic-flashcard/basic-flashcard.component");
// Définissez vos routes ici
var routes = [
    // Par exemple, la route pour le composant de connexion
    { path: 'login', component: login_component_1.LoginComponent },
    { path: 'navbar', component: nav_bar_component_1.NavBarComponent },
    { path: 'basic-flashcard', component: basic_flashcard_component_1.BasicFlashcardComponent },
];
